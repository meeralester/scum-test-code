...
int main(void) {
	...
	RFTIMER_REG__COMPARE0 = 0x00004E20;
	RFTIMER_REG__COMPARE1 = 0x000009C4;
	RFTIMER_REG__COMPARE2 = 0x00001D4C;
	RFTIMER_REG__COMPARE3 = 0x000030D4;
	RFTIMER_REG__COMPARE4 = 0x0000445C;
